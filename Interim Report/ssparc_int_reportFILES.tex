...
\newabbrev\TR{tone reservation (TR)}[TR]
\newabbrev\TI{tone injection (TI)}[TI]
\newabbrev\ACE{active constellation extension (ACE)}[ACE]
\newabbrev\BER{bit error rate (BER)}[BER]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{SummaryIntroFILE.tex}
\section{SSAS Project Status}
\input{Thrust1aggreFILE.tex}
